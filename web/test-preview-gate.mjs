...
expect(response.headers.get("x-starglass-preview") === "private-gate-v2", "gate response should carry its deployment marker");
...
expect(response.headers.get("x-starglass-preview") === "private-gate-v2", "authorized response should carry the gate marker");
