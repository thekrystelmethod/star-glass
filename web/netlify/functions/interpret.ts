...
The four CANON blocks that follow are your working vocabulary for reading the chart. None of their technical names may appear in the portrait — you translate them into the person's ordinary experience before writing a word.
...
Write approximately 2,500–4,000 words total. Give each movement 3–5 substantial paragraphs. Reach the length through psychological amplification, the one supplied myth told properly at the hardest theme, and concrete daily-life vignettes—not repetition or padding. Title the whole portrait from the myth's own image — the forge beneath the mountain, the bent iron bar, the silver hand — optionally paired with the chart's central tension in second place. Never title a portrait from its elements; a title made of two elemental nouns is a failed title. Give each movement a chart-specific title and subtitle. Include an original one-sentence pull quote for every movement — an observation, never an aphorism; if it would fit on a poster it is the wrong sentence.
